...
/* Unmerged change from project 'Beamasp.GeoLocator.RVE (net452)'
Before:
...
*/
using Beamasp.GeoLocator.RVE.Exceptions;
using Beamasp.GeoLocator.RVE.Internals;
using Beamasp.GeoLocator.RVE.Results;
using RestSharp;
using System;
